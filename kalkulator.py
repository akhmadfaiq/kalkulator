...
equal = Button(root,text="=",padx = 30,bg="blue",fg="red", pady = 20,command=samadengan)
btntitik = Button(root,text=".",padx = 30,bg="red", pady = 20,command=lambda:cetak("."))
